      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <p className="hero-description">
            I am a beginner in the field of all things tech. hope to make difference in the world.
          </p>
        ...
        <div className="hero-visual">
          <div className="hero-code-snippet">
            ...
            <div className="code-line indent">
              <span className="code-property">name</span>: <span className="code-string">'Zain Bughio'</span>,
            </div>
            <div className="code-line indent">
